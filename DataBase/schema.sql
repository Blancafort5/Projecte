...
CREATE TABLE IF NOT EXISTS `newgame`.`Users` (
  ...
  `Provinces_provinces_id_province` INT NOT NULL,
  PRIMARY KEY (`users_id_user`, `Provinces_provinces_id_province`),
  UNIQUE INDEX `usuarios_id_usuarios_UNIQUE` (`users_id_user` ASC),
...
CREATE TABLE IF NOT EXISTS `newgame`.`Bills` (
  ...
  `Users_Provinces_provinces_id_province` INT NOT NULL,
  PRIMARY KEY (`bills_id_bill`, `Users_users_id_user`, `Users_Provinces_provinces_id_province`),
  INDEX `fk_Bills_Users1_idx` (`Users_users_id_user` ASC, `Users_Provinces_provinces_id_province` ASC),
  CONSTRAINT `fk_Bills_Users1`
    FOREIGN KEY (`Users_users_id_user` , `Users_Provinces_provinces_id_province`)
    REFERENCES `newgame`.`Users` (`users_id_user` , `Provinces_provinces_id_province`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `newgame`.`Bill_Details` (
  ...
  `bill_detail_id_game` INT NOT NULL,
  `bill_details_quantity` VARCHAR(45) NOT NULL,
  INDEX `fk_Bill_Details_Bills1_idx` (`bill_id_bill` ASC),
  INDEX `fk_Bill_Details_Games1_idx` (`bill_detail_id_game` ASC),
  PRIMARY KEY (`bill_id_bill`, `bill_detail_id_game`),
  ...
  CONSTRAINT `fk_Bill_Details_Games1`
    FOREIGN KEY (`bill_detail_id_game`)
...
CREATE TABLE IF NOT EXISTS `newgame`.`Replies` (
  ...
  `replies_created_date` DATETIME NOT NULL,
...
-- -----------------------------------------------------
-- Table `newgame`.`Reservations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `newgame`.`Reservations` ;

CREATE TABLE IF NOT EXISTS `newgame`.`Reservations` (
  `reservations_id_reservation` INT NOT NULL AUTO_INCREMENT,
  `Users_users_id_user` INT NOT NULL,
  `Games_games_id_game` INT NOT NULL,
  `Games_Genders_genders_id_gender` INT NOT NULL,
  `Games_Forums_forums_id_forum` INT NOT NULL,
  PRIMARY KEY (`reservations_id_reservation`, `Users_users_id_user`, `Games_games_id_game`, `Games_Genders_genders_id_gender`, `Games_Forums_forums_id_forum`),
  INDEX `fk_Reservations_Users1_idx` (`Users_users_id_user` ASC),
  INDEX `fk_Reservations_Games1_idx` (`Games_games_id_game` ASC, `Games_Genders_genders_id_gender` ASC, `Games_Forums_forums_id_forum` ASC),
  CONSTRAINT `fk_Reservations_Users1`
    FOREIGN KEY (`Users_users_id_user`)
    REFERENCES `newgame`.`Users` (`users_id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Reservations_Games1`
    FOREIGN KEY (`Games_games_id_game` , `Games_Genders_genders_id_gender`)
    REFERENCES `newgame`.`Games` (`games_id_game` , `Genders_genders_id_gender`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_unicode_ci
COMMENT = 'Reservations table';
